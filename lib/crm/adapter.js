...
//
// PIPELINE-CONTEXT: Uses this.pool.query intentionally — CRM sync runs as a
// pipeline operation. The pool is passed by the caller (route handler or script).
// Sync logging goes to crm_sync_log (platform table).
//
