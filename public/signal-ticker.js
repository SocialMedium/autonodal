...
(function() {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      '#signal-ticker{height:44px;background:url(https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1600&h=100&fit=crop&crop=bottom&q=60) center/cover no-repeat;display:flex;align-items:stretch;font-family:var(--mono,"IBM Plex Mono",monospace);font-size:11px;overflow:hidden;color:#e8edf3;width:100%;position:relative}',
      '#signal-ticker::before{content:\"\";position:absolute;inset:0;background:rgba(15,23,42,0.45);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);z-index:0}',
      '#signal-ticker>*{position:relative;z-index:1}',
      '#signal-ticker.si-top{position:relative;width:100%;border-bottom:1px solid rgba(200,210,230,0.15)}',
      '#signal-ticker.si-bottom{position:fixed;bottom:0;left:0;right:0;border-top:1px solid rgba(200,210,230,0.15);z-index:9999}',
      '#signal-ticker.si-fixed-top{position:fixed;top:0;left:0;right:0;border-bottom:1px solid rgba(200,210,230,0.15);box-shadow:0 1px 8px rgba(0,0,0,.15);z-index:9999}',
      'body.si-top-offset{padding-top:44px}',
      'body.si-bottom-offset{padding-bottom:44px}',
      '.si-live{display:flex;align-items:center;gap:6px;padding:0 12px;border-right:1px solid rgba(200,210,230,0.12);flex-shrink:0;white-space:nowrap}',
      ...
      '.si-stat{display:flex;align-items:center;gap:3px;padding:0 10px;border-right:1px solid rgba(200,210,230,0.12);flex-shrink:0;color:#b0bac6;white-space:nowrap;font-size:10px}',
      ...
      '.si-stk{display:inline-flex;align-items:center;gap:6px;padding:0 16px;height:44px;border-right:1px solid rgba(200,210,230,0.12);cursor:default;font-size:11px}',
      ...
      '.si-bar{background:rgba(200,210,230,0.12)}.si-bar i{display:block;height:100%;border-radius:2px;transition:width .5s}',
      '.si-ctrl{display:flex;align-items:center;gap:1px;padding:0 6px;border-left:1px solid rgba(200,210,230,0.12);flex-shrink:0}',
      ...
      '.si-btn:hover{background:rgba(200,210,230,0.12);color:#e8edf3}',
      '.si-btn.on{background:rgba(200,210,230,0.15);color:#f0f6fc;font-weight:600}',
      '#si-panel{position:fixed;right:0;width:400px;background:rgba(15,23,42,0.85);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid rgba(200,210,230,0.15);padding:14px;z-index:9998;box-shadow:-4px -4px 20px rgba(0,0,0,.2);font-family:var(--mono,"IBM Plex Mono",monospace);font-size:11px;color:#e8edf3;display:none}',
